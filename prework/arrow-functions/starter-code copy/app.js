...
// it refers to the window when we use the arrow.
// 3. Explain why "this" is different when an arrow function is used.
//because when we use arrow function this refers to whatever encloses on it (in most cases it will be the window, unless the arrow function is in another container).
